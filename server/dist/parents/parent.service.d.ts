...
export declare class ParentService {
    ...
    getParentByUsernameAndPassword(username: string, password: string): Promise<Parent | null>;
    createParent(parentDto: ParentDto): Promise<Parent>;
    getAllParents(): Promise<Parent[]>;
    getParentById(id: string): Promise<Parent>;
}
