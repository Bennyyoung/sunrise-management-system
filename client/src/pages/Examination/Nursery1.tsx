...
const Grade4: React.FC = () => {
  ...
  const resultList = () => {
    return results
      .filter(currentresult => currentresult.studentclass === 'Nursery 1' && currentresult)
      .map(currentresult => (
          ...
          <div className="row page-titles mx-0">
            ...
            <div className="col-sm-6 p-md-0 justify-content-sm-end mt-2 mt-sm-0 d-flex">
              <ol className="breadcrumb">
                ...
                <li className="breadcrumb-item active"><Link to="/nursery-1">Nursery 1 Results</Link></li>
              </ol>
            </div>
          </div>
